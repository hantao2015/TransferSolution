...
{
    internal class ChatReader : IClientCommandReader<BaseCommandInfo>
    {
        ...
        internal ChatReader(ChatEngine engine)
        {
            m_OPTypeLength = 1;
            m_OPCodeLength = 1;
            m_ParaCountLength = 1;
        ...
        public ChatReader(ChatReader previousCommandReader)
        {
            m_OPTypeLength = 1;
            m_OPCodeLength = 1;
            m_ParaCountLength = 1;
        ...
        internal ChatEngine Engine { get; private set; }
    }
}
